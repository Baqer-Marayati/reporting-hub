...
$archiveDir = Join-Path $RepoRoot "Reports\Marketing\Exports\Server Packages\archive"
if (!(Test-Path $runner)) { throw "Portfolio archive-prune script not found: $runner" }
